...
public class JsonUtils {
    ...
    public static Sandwich parseSandwichJson(String json) {
        int mainNameIndex = json.indexOf(MAIN_NAME_KEY) + MAIN_NAME_KEY.length() + 3; // move past ":"
        int akaIndex = json.indexOf(AKA_KEY) + AKA_KEY.length() + 3; // move past ":[
        int originIndex = json.indexOf(ORIGIN_KEY) + ORIGIN_KEY.length() + 3; // move past ":"
        int descriptionIndex = json.indexOf(DESCRIPTION_KEY) + DESCRIPTION_KEY.length() + 3; // move past ":"
        int imageIndex = json.indexOf(IMAGE_KEY) + IMAGE_KEY.length() + 3; // move past ":"
        int ingredientsIndex = json.indexOf(INGREDIENTS_KEY) + INGREDIENTS_KEY.length() + 3; // move past ":[
